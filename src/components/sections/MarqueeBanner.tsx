...
export const MarqueeBanner: React.FC = () => {
  const tickerItems = [
    ...
    { text: 'Unggul dalam Prestasi & IPTEK', icon: <Trophy className="w-4 h-4 text-emerald-300" /> },
    ...
    <div className="relative w-full overflow-hidden bg-gradient-to-r from-[#047857] via-[#059669] to-[#0d9488] text-white py-4 shadow-md border-y border-emerald-600">
      ...
      >
        {allItems.map((item, idx) => (
          <div key={idx} className="flex items-center gap-3 text-xs sm:text-sm font-bold tracking-wide">
